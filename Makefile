...
$(EXEC): main.o Directory.o Menu.o Header.o Parse.o ParseCpp.o ParseJava.o LinuxNotification.o #Indenter.o
	$(CC) -o $@ $^ $(CXXFLAGS)

main.o: main.cpp Directory.h  Menu.h Header.h Parse.h ParseCpp.h ParseJava.h #Indenter.h
	$(CC) $(CXXFLAGS) -o $@ -c $< 
...
Parse.o: Parse.cpp Parse.h Header.h
	gcc-8 --std=c++17 -lstdc++fs -O0 -Wall -o $@ -c $<
