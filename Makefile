...
$(EXEC): main.o Menu.o Header.o Parse.o ParseCpp.o ParseJava.o Directory.o LinuxNotification.o Indenter.o
	$(CC) -o $@ $^ $(CXXFLAGS)

main.o: main.cpp Menu.h Header.h Parse.h ParseCpp.h ParseJava.h Directory.h Indenter.h
	$(CC) $(CXXFLAGS) -o $@ -c $< 
